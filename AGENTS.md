...
/docs
  ...
  /docs/skills-agents      → autogenerated sidebar: standing-rules-vs-memory.md (overview
                             page with placeholder subsections, e.g. "Skills") plus
                             evaluating-third-party-skills.md (a subsection that's already
                             graduated into its own page — the pattern to repeat: start
